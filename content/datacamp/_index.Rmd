...
### Advice
Carve out some time everyday to go through these. If you try to complete everything in one sitting, it will probably be overwhelming! However if you have familiarity with some modules and anotehr is availible, please feel free to work ahead.
...
dc_schedule <- read_csv("dc.csv",
            ...
            mutate(across(everything(), as.character)) %>%
              ...
              rename(`Chapters covered` = Chapters_long)  %>%
