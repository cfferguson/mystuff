...
- Use this [link](/slides/Descriptions/Slides-Week-4.html){target="_blank"} to view a larger version of slideshow in a new window.

```{r echo = FALSE}
knitr::include_url("/slides/Week 4/Slides-MRE.html")
```
