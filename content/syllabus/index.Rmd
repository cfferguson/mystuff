...
You can also use this [link](/slides/Descriptions/Slides-MRE.html){target="_blank"} to view a larger version of slideshow in a new window or download it as a [PDF](/slides/Descriptions/Slides-MRE.pdf).
