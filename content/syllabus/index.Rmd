...
- Third using Twitter you can post R-related questions and content with [#rstats](https://twitter.com/search?q=%23rstats){target="_blank"}. The community there is exceptionally helpful.
...
- Fifth we have a class chatroom which may be accessed via [Slack](https://2021edp613.slack.com){target="_blank"} where you can poise a question. **I will monitor Slack regularly and will respond relatively quickly.** Ask questions about the readings, exercises, and other course materials. You'll likely have similar questions as your peers and may be able to answer other peoples' questions too.
