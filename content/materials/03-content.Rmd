...
powerpoint_link <- function() {
  paste0("<a href=\"", pptx_location, "\">", as.character(fa("file-powerpoint")), "</a>")
}

word_link <- function() {
  paste0("<a href=\"", docx_location, "\">", as.character(fa("file-word")), "</a>")
}
...
Want to see a larger version of the presentation? Click this [link](/slides/Week 3/Slides-Week-3.html){target="_blank"}.
