...
linktitle: "Week 13: Analysis of Variance"
output:
  blogdown::html_page:
    toc: true
menu:
...
This week we are combing the next two weeks because it makes sense to do so. In opposite order of you text, we have *regression* followed by the idea and implementation of an ANOVA.
