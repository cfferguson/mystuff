...
> See the ["Spacing" section](https://style.tidyverse.org/syntax.html#spacing){target="_blank"} in the tidyverse style guide.
...
> See the ["Long lines" section](https://style.tidyverse.org/syntax.html#long-lines){target="_blank"} in the tidyverse style guide.
...
> See the ["Comments" section](https://style.tidyverse.org/syntax.html#comments){target="_blank"} in the tidyverse style guide.
