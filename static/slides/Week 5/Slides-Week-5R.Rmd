...
`r chunk_reveal(chunk_name = "sw4a", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "sw4b", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "sw4c", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "sw5a", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "sw5b", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "sw5c", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swiba", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swibb", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swibc", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swibd", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swwrangle", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swdems", color = c("white", "white", "white"))`
...
ggplot(nfl_percentages, aes(reorder(Team, percent_rep), 
                            percent_rep,
                            fill = percent_rep)) +
  geom_bar(stat="identity") +
  coord_flip() +
...
`r chunk_reveal(chunk_name = "swgops", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swpivot", color = c("white", "white", "white"))`
...
`r chunk_reveal(chunk_name = "swfacet", color = c("white", "white", "white"))`
